...
> -   You will also have access to RStudio Server Pro through the MSIA program
...
> -   Functions
> -   Help files
> -   Comments (anything following `#` in a code file)
...
All of our materials are available at www.github.com/msia/bootcamp-2021. Today, you will only need to work with two files: `R1_exercises.R` from the `exercises` directory and `gampinder5.csv` from the `data` directory.

Starting with the R3 session on Wednesday, you will be working with a much wider set of files. On Wednesday, you will learn how to make a copy of the whole bootcamp-2021 repository using Git.
...
-   Install the package `tidyverse`<br><small>(You only need to do this the first time)</small>
